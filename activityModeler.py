...
def getFeatureForTest(activityDataSet):


		alldata = activityDataSet
		#print alldata
		#rows = np.array(data[:,1]).astype(np.float)
...
def predictActivity(clf,features):
...
def main():
	...
	for x in range (0,20):
		fc2 = getFeatureForTest(walkData, drinkData, typeData, eatData, tvData, 5000+x*200, 5000+x*200+400, freqDecimate100 )
